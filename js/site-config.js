...
window.SiteConfig = {
    ...
    cookieConsent: {
        storageKey: 'stepEaseCookieConsent',
        title: 'Privacy preferences',
        text:
            'StepEase uses basic cookies and similar technologies to improve site functionality and understand general usage. Please review our policies before continuing.',
        acceptText: 'Accept',
        declineText: 'Decline'
    }
};
